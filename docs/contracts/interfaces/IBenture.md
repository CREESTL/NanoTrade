...
_An interface for dividends distributing contract_
...
| dueDate   | uint256 | The number of seconds in which the dividends will be paid _after the announcement_ |
...
_Indicates that new dividends distribution was announced_
...
_Indicates that dividends distribution was cancelled_
...
_Indicates that dividends were distributed_
...
_Indicates that dividends distribution was fulfilled_
