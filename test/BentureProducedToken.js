...
describe("Benture Produced Token", () => {
  ...
  describe("Mint", () => {
    ...
    it('Should fail to mint more than `maxTotalSupply` of tokens', async() => {
      ...
      await expect(token.mint(clientAcc1.address, amount))
      .to.be.revertedWith("BentureProducedToken: supply exceeds maximum supply!");
    });

    it('Should fail to mint to zero address', async() => {
      let amount = 1000;
      await expect(token.mint(zeroAddress, amount))
      .to.be.revertedWith("BentureProducedToken: can not mint to zero address!");
    });
  ...
  describe("Burn", () => {
    ...
    it('Should fail to burn tokens if caller does not have any', async() => {
      ...
      .to.be.revertedWith("BentureProducedToken: caller does not have any tokens to burn!");
    });
  ...
  describe("Transfer", () => {
    ...
    it('Should fail to transfer tokens if receiver has zero address', async() => {
      ...
      .to.be.revertedWith("BentureProducedToken: receiver can not be a zero address!");
    });

    it('Should fail to transfer tokens if sender has no tokens', async() => {
      let amount = 1000;
      await expect(token.connect(clientAcc1).transfer(clientAcc2.address, amount))
      .to.be.revertedWith("BentureProducedToken: sender does not have any tokens to transfer!");
    });
  ...
  describe("Constructor", () => {
    ...
    it('Should fail to initialize with wrong name', async() => {
      ...
      .to.be.revertedWith("BentureProducedToken: initial token name can not be empty!");
    });
    ...
    it('Should fail to initialize with wrong symbol', async() => {
      ...
      .to.be.revertedWith("BentureProducedToken: initial token symbol can not be empty!");
    });
    ...
    it('Should fail to initialize with wrong decimals', async() => {
      ...
      .to.be.revertedWith("BentureProducedToken: initial decimals can not be zero!");
    });
    ...
    it('Should fail to initialize with wrong admin token address', async() => {
      ...
      .to.be.revertedWith("BentureProducedToken: admin token address can not be a zero address!");
    });
    ...
    it('Should fail to initialize with wrong max total supply', async() => {
      ...
      .to.be.revertedWith("BentureProducedToken: max total supply can not be zero!");
    });
    ...
    it('Should fail to initialize with any max total supply if non-mintable', async() => {
      ...
      .to.be.revertedWith("BentureProducedToken: max total supply must be zero for unmintable tokens!");
    });
