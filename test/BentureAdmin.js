...
describe("Benture Admin Token", () => {
  ...
  describe("Constructor", () => {
    ...
    it('Should fail to initialize with zero factory address', async() => {
      ...
      .to.be.revertedWith("BentureAdmin: factory address can not be zero address!"); 
    });
  ...
  describe("Getters", () => {
    ...
    it('Should fail to check that zero address owns admin token', async() => {
      ...
      .to.be.revertedWith("BentureAdmin: zero address is an invalid user!");
    });
    ...
    it('Should fail to get the address of controlled ERC20 token by invalid admin token ID', async() => {
      ...
      .to.be.revertedWith("BentureAdmin: no controlled token exists for this admin token!");
    });
  ...
  describe("Mint", () => {
    ...
    it('Should fail to mint a new admin token to zero address', async() => {
      ...
      .to.be.revertedWith("BentureAdmin: admin token mint to zero address is not allowed!");
    });
    ...
    it('Should fail to mint a new admin token and connect in to zero address', async() => {
      ...
      .to.be.revertedWith("BentureAdmin: controlled token can not have a zero address!");
    });
    ...
    it('Should fail to mint a new admin token to the same account twice', async() => {
      ...
      .to.be.revertedWith("BentureAdmin: only a single admin token is allowed for a single controlled token!");
    });
  ...
  describe("Burn", () => {
    ...
    it('Should fail to burn token if caller is not an owner', async() => {
      ...
      .to.be.revertedWith("BentureAdmin: only owner of the token is allowed to burn it!");
    });
